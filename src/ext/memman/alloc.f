\ alloc.f   - memory manager allocation
\ ------------------------------------------------------------------------
...
: (scan-heaps)      ( size ix heap --- size mem-blk t | size f )
  dup>r h.mapf@             \ point to free mem-map
