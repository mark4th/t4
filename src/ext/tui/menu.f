\ menu.f        - text user interface menu creation
\ ------------------------------------------------------------------------
...
\ at compile time so this will still work for turnkeyed applications

struct: menu
  /node: mnu.list           \ linked list entries
...
: menu:         ( --- a1 0 )
  create here node allot    \ create menu
...
: menu-bar:     ( --- bar 0 )
  ...
  here list allot           \ reset menu item linked list
  list erase ;
