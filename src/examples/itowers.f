\ itower.f      - itterative towers of hanoi solution
\ ------------------------------------------------------------------------
...
\ ------------------------------------------------------------------------
 ...
 create t0 30 allot t0 30 erase align,
 create t1 30 allot t1 30 erase align,
 create t2 30 allot t2 30 erase align,
...
: dokey
  key bl =                 \ quit (change to bye if doing a turnkey)
  ?: quit noop  ;
