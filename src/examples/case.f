\ case.f        - an example of how to use case: statements in this forth
\ ------------------------------------------------------------------------
...
\ thus far where i enforce good programming practices.
\
\ case
...
\ or you can use my method and keep your code well factored, readable
\ and much easier to maintain down the road.
...
\ uncomment the aove 4 lines then have t4 interpret this file. it
\ will save out an executable called foo that you can run on any armv7
\ linux box even if t4 isnt installed there.
