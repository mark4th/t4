...
create lorem
 ...
 here align,
 const ipsum                \ end address of lorem string
...
\ ------------------------------------------------------------------------
\ create a menu bar and populate it with pulldown menus
...
\ ------------------------------------------------------------------------
\ move slidy window back and forth
...
: (main)
  begin
    incr> c1 c1 15 = if off> c1 .lorem then
    incr> c2 c2  2 = if off> c2 slide then
    test-screen .screen
    key?
  until ;
