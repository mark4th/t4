...
\ ------------------------------------------------------------------------
  ...
  40 constant x_off         \ world coordinates of shape
  40 constant y_off
  150 constant z_off
...
: sin@  ( angle --- sin ) 2* sin_tab + w@ sxth ;
...
: project       ( x y z --- xx yy )
  swap y_off * over z_off + height 2/ /+
...
\ but first create a stripped down version of src/t4.f to compile
